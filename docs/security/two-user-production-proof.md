...
3. Set `BUILDIT_E2E_BASE_URL`, both state-file paths, both organization names, both unique markers, and both review paths in the local shell without printing them.
