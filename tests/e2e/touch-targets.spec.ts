...
const routes = ["/", "/sign-in", "/data-handling", "/pricing", "/sandbox", "/setup/install", "/setup/repository", "/setup/model", "/setup/health", "/reviews?tour=1", "/reviews/418?tour=1", "/reviews/418?tour=1&state=changes", "/reviews/418?tour=1&state=passed", "/reviews/418?tour=1&state=running", "/reviews/418?tour=1&state=cancelled", "/reviews/418?tour=1&state=empty", "/repositories?tour=1", "/usage?tour=1"];
const minimum = 44;
