...
function Integrations() {
  return <div className="content"><Header eyebrow="Dependency-specific setup" title="Integrations" description="Connect only the service needed for the next action. No all-or-nothing setup wall." /><div className="integration-grid"><GitHubIntegrationState /><Integration name="Anthropic / OpenAI / Gemini" status="Connect when analyzing" description="Your key is used only for the provider request you authorize." action="Compare model setup" href="/setup/model" /><UnavailableIntegration name="Linear" description="Private Linear issue access is not enabled. BuildIT will mark linked Linear context unavailable rather than infer requirements." /><UnavailableIntegration name="Jira" description="Private Jira ticket access is not enabled. BuildIT will mark linked Jira context unavailable rather than infer requirements." /></div></div>;
}
