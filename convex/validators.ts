...
export const provider = v.union(v.literal("anthropic"), v.literal("openai"), v.literal("gemini"));
...
export const coverageGap = v.union(v.literal("changed_files"), v.literal("diff_truncated"), v.literal("requirements"), v.literal("analysis_budget"));
...
export const statusReasonCode = v.union(
  ...
  v.literal("spend_ceiling_reached"), v.literal("concurrency_limit_reached"), v.literal("superseded_by_new_commit"), v.literal("provider_rate_limited"), v.literal("provider_quota_exhausted"), v.literal("platform_error"),
