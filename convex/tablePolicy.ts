...
export const tablePolicies = {
  ...
  trackerOAuthStates: { scope: "organization", parents: ["organizationId", "repositoryId", "userId", "replacesConnectionId"], data: "encrypted_secret" },
  ...
  usageMonths: { scope: "organization", parents: ["organizationId"], data: "metadata" },
  modelInvocations: { scope: "review", parents: ["organizationId", "repositoryId", "reviewId", "ledgerId"], data: "metadata" },
  ...
  executionJobs: { scope: "review", parents: ["organizationId", "repositoryId", "reviewId"], data: "metadata" },
