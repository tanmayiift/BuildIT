...
export const storedTextClassifications = {
  ...
  dedupeKey: "operational_identifier", statusDetail: "metadata", coverageGap: "metadata", promptInjectionSurfaces: "metadata", defaultBranch: "metadata", deliveryId: "operational_identifier",
