...
export const storedTextClassifications = {
  ...
  dedupeKey: "operational_identifier", statusDetail: "metadata", coverageGap: "metadata", unreadableSources: "metadata", changeSummary: "metadata", reviewProfile: "metadata", reviewPathFilters: "metadata", reviewTrigger: "metadata", approvedConfigHash: "metadata", approvedConfigBy: "operational_identifier", pausedBy: "operational_identifier", pausedAt: "metadata", summary: "metadata", nextStep: "metadata", monthlySpendMicros: "metadata", monthlySpendMonth: "metadata", expiresAt: "metadata", promptInjectionSurfaces: "metadata", defaultBranch: "metadata", deliveryId: "operational_identifier",
