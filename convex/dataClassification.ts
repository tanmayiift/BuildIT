...
export const storedTextClassifications = {
  ...
  dedupeKey: "operational_identifier", pendingConfigHash: "operational_identifier", statusDetail: "metadata", coverageGap: "metadata", unreadableSources: "metadata", changeSummary: "metadata", configNote: "metadata", reviewProfile: "metadata", reviewPathFilters: "metadata", reviewTrigger: "metadata", approvedConfigHash: "metadata", changelogOnMerge: "metadata", approvedConfigBy: "operational_identifier", ruleKey: "metadata", pathPrefixHmac: "operational_identifier", verdict: "metadata", actorHash: "operational_identifier", occurredAt: "metadata", pausedBy: "operational_identifier", pausedAt: "metadata", summary: "metadata", nextStep: "metadata", monthlySpendMicros: "metadata", monthlySpendMonth: "metadata", expiresAt: "metadata", promptInjectionSurfaces: "metadata", defaultBranch: "metadata", deliveryId: "operational_identifier",
  deletionLeaseId: "operational_identifier", deletionTerminalAt: "metadata", lastDeletionErrorCode: "metadata",
  ...
  evalSetVersion: "metadata", event: "metadata", eventHash: "hashed_metadata", executionFingerprint: "hashed_metadata",
  ...
  networkPolicyVersion: "metadata", nonce: "encrypted_secret", observedHeadSha: "operational_identifier", outputHash: "hashed_metadata",
